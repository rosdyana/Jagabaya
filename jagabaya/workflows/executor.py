...
class WorkflowResult:
    ...
    def successful_steps(self) -> int:
        ...
        return sum(sum(1 for s in p.step_results if s.success) for p in self.phase_results)
    ...
    async def execute(
        ...
        try:
            for phase in workflow.phases:
                ...
                if phase.skip_if and self._evaluate_condition(
                    phase.skip_if, session, all_variables
                ):
